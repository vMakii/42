...
/*   Updated: 2025/09/22 15:26:43 by mivogel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    DiamondTrap DiamondTrap1("Kevin");
    DiamondTrap DiamondTrap2(DiamondTrap1);
    DiamondTrap DiamondTrap3;

    std::cout << std::endl;
    DiamondTrap0.whoAmI();
    std::cout << "Hit points: " << DiamondTrap0.getHitPoints() << std::endl;
    std::cout << "Energy points: " << DiamondTrap0.getEnergyPoints() << std::endl;
    std::cout << "Attack damage: " << DiamondTrap0.getAttackDamage() << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "Attack damage: " << DiamondTrap1.getAttackDamage() << std::endl;
    std::cout << std::endl;
    
    std::cout << std::endl;
    DiamondTrap2.whoAmI();
    std::cout << "Hit points: " << DiamondTrap2.getHitPoints() << std::endl;
    std::cout << "Energy points: " << DiamondTrap2.getEnergyPoints() << std::endl;
    std::cout << "Attack damage: " << DiamondTrap2.getAttackDamage() << std::endl;
    std::cout << std::endl;
    
    DiamondTrap3 = DiamondTrap1;
    std::cout << std::endl;
    DiamondTrap3.whoAmI();
    std::cout << "Hit points: " << DiamondTrap3.getHitPoints() << std::endl;
    std::cout << "Energy points: " << DiamondTrap3.getEnergyPoints() << std::endl;
    std::cout << "Attack damage: " << DiamondTrap3.getAttackDamage() << std::endl;
    std::cout << std::endl;
    
    DiamondTrap1.attack("Bob");
    DiamondTrap1.takeDamage(5);
    DiamondTrap1.beRepaired(3);
