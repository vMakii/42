...
/*   Updated: 2025/09/18 16:55:24 by mivogel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ScavTrap::attack(const std::string& target) 
{
    ...
    {
        std::cout << "\033[34mScavTrap " << _name << " has no hit points left to attack.\033[0m" << std::endl;
    } 
    else
    {
        std::cout << "\033[34mScavTrap " << _name << " has no energy left to attack.\033[0m" << std::endl;
    }
}
...
void ScavTrap::guardGate() 
{
    ...
    {
        std::cout << "\033[34mScavTrap " << _name << " is already in Gate Keeper mode.\033[0m" << std::endl;
    }
}